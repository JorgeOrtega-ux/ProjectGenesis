...
-- ----------------------------
-- Records for site_settings (Seed Data)
-- ----------------------------
...
-- ----------------------------
-- Records for communities (Seed Data)
-- ----------------------------
...
-- ----------------------------
-- --- ▼▼▼ INICIO DE TABLAS NUEVAS (PARA CHAT DE COMUNIDAD) ▼▼▼ ---
-- ----------------------------
...
CREATE TABLE `community_chat_messages` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `idx_community_time` (`community_id`, `created_at`),
  KEY `sender_id` (`sender_id`),
  KEY `reply_to_message_id` (`reply_to_message_id`),
  CONSTRAINT `community_chat_ibfk_1` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE,
  CONSTRAINT `community_chat_ibfk_2` FOREIGN KEY (`sender_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `community_chat_ibfk_3` FOREIGN KEY (`reply_to_message_id`) REFERENCES `community_chat_messages` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- ----------------------------
-- Table structure for community_chat_message_attachments
-- ----------------------------
DROP TABLE IF EXISTS `community_chat_message_attachments`;
CREATE TABLE `community_chat_message_attachments` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `message_id` bigint(20) NOT NULL,
  `file_id` bigint(20) NOT NULL,
  `sort_order` int(11) NOT NULL DEFAULT 0,
  ...
  UNIQUE KEY `uk_message_file` (`message_id`,`file_id`),
  KEY `file_id` (`file_id`),
  CONSTRAINT `community_chat_attachments_ibfk_1` FOREIGN KEY (`message_id`) REFERENCES `community_chat_messages` (`id`) ON DELETE CASCADE,
  CONSTRAINT `community_chat_attachments_ibfk_2` FOREIGN KEY (`file_id`) REFERENCES `chat_files` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- ----------------------------
-- Table structure for user_community_chat_metadata
-- ----------------------------
DROP TABLE IF EXISTS `user_community_chat_metadata`;
CREATE TABLE `user_community_chat_metadata` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT 'El usuario que posee esta metadata',
  `community_id` int(11) NOT NULL COMMENT 'La comunidad que se está viendo',
  `last_read_message_id` bigint(20) DEFAULT 0 COMMENT 'El ID del último mensaje leído por este usuario en este chat',
  ...
  UNIQUE KEY `uk_user_community` (`user_id`, `community_id`),
  KEY `community_id` (`community_id`),
  CONSTRAINT `user_comm_meta_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_comm_meta_ibfk_2` FOREIGN KEY (`community_id`) REFERENCES `communities` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
