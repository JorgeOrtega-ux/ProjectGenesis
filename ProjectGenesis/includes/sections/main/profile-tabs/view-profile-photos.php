...
$profile = $viewProfileData; // <-- Aseguramos que $profile esté definido
$isOwnProfile = ($viewProfileData['friendship_status'] === 'self'); // <-- Aseguramos que $isOwnProfile esté definido
$currentTab = $viewProfileData['current_tab'] ?? 'posts'; // <-- Aseguramos que $currentTab esté definido
