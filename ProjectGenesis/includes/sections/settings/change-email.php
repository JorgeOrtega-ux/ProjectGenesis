...
<div class="section-content <?php echo ($CURRENT_SECTION === 'settings-change-email') ? 'active' : 'disabled'; ?>" data-section="settings-change-email">
    <div class="settings-wrapper">
        ...
        <div class="settings-card settings-card--edit-mode" id="email-step-1-verify">
        ...
        <div class="settings-card settings-card--edit-mode" id="email-step-2-update" style="display: none;">
            <div class="settings-card__content">
                <div class="settings-card__icon">
                ...
                <div class="settings-card__text">
                    ...
                    <div class="modal__input-group" style="margin-top: 8px;">
                        <input type="email"
                           ...
                           required
                           maxlength="255">
                        <label for="email-input-new" data-i18n="settings.email.newEmailLabel"></label>
                    </div>
                </div>
            </div>
            <div class="settings-card__actions">
